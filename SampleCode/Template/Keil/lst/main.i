...
void UART0_Init(void)
{
	...
	UART_SetTimeoutCnt(((UART_T *) ((( uint32_t)0x40000000) + 0x70000)), 20);
...
void SYS_Init(void)
{
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPB_MFPH & ~((0xful << (24)))) | (0x0EUL<<(24));
